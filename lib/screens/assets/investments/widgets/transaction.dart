...
class _TransactionScreenState extends State<TransactionScreen> {
  ...
  void initState() {
    super.initState();
    // Initial fetch with ISIN code if provided
  ...
  List<invtypes.Investment> _getFilteredItems(invtypes.Data? transactions) {
    ...
    List<invtypes.Investment> filtered;
    switch (_selectedFilter) {
      case 'EQUITY':
        filtered = transactions.equities;
        break;
      case 'MUTUAL FUNDS':
        filtered = transactions.mfs;
        break;
      case 'ETF':
        filtered = transactions.etfs;
        break;
      case 'ALL':
      default:
        filtered = [
              ...
              CustomAccordion(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    if (!widget.category.toUpperCase().contains('EQUITY') &&
                        !widget.category.toUpperCase().contains('ETF')) ...[
                      _buildDetailRow(
                        "Average Price",
